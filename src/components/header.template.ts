...
<div class="data-table-header form-group form-inline">
    <div class="form-group pull-right">
        <h4 class="title" [textContent]="dataTable.headerTitle"></h4>
        <ng-template [ngIf]="dataTable.enableSearch"> Search : 
            <input #tlbSearch [(ngModel)]="searchString" type="text" class="form-control" />
        </ng-template>
    </div>
